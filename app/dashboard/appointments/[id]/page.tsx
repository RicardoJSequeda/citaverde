          ...
          <CardHeader>
            <div className="flex items-center justify-between mb-2">
              <div
                ...
                style={{ backgroundColor: appointment.service_type?.color || "#3b82f6" }}
              >
                {appointmentDate.getDate()}
              </div>
              <div
                className={`px-3 py-1 rounded-full text-sm font-medium border ${statusColor[appointment.status as keyof typeof statusColor]}`}
              >
